...
Copies the published files from their vault locations into this folder,
...
FILES = {
    ...
    SRC / "Data" / "reads.json":             HERE / "Data" / "reads.json",   # Reads tab + SoS strips (2026-06-10)
    SRC / "Data" / "topic-digest.json":      HERE / "Data" / "topic-digest.json",  # Topics tab (2026-06-12)
